...
export default function PublicEcosystemCard({ ecosystem }) {
  ...
  return (
    <div className="mb-6 flex flex-col rounded-lg overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl lg:w-full lg:h-[80vh]">
      <div
      ...
      >
        ...
        <div className="relative z-10 px-10 py-6 flex flex-col justify-between flex-grow">
          ...
          <div className="flex justify-center mt-6">
            <button
              className="inline-flex justify-center rounded-full bg-[#6600cc] px-6 py-3 font-bold uppercase text-white hover:scale-105 transition-all"
